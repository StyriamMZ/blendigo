...
class GeometryExporter(SceneIterator):
    ...
    def exportModelElements(self, ob_inst, mesh_definition, matrix):
        ...
        key = hash((ob_inst, *ob_inst.persistent_id, ob_inst.random_id, obj.name, obj.data.name, ob_inst.parent)) # the more the merrier. ob_insts can have identical hash and random_id... 
